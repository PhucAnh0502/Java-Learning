        ...
        <div class="home-container">
            <div class="filter-container">
                <div class="filter-item">
                    <h5>Supplier</h5>
                    <% String selectedSupplierId = (String) request.getParameter("supplierId");  %>
                    <div class="">
                        <% ArrayList<Supplier> supplierList = (ArrayList<Supplier>) request.getAttribute("supplierList"); %>
                        <% for (Supplier supplier : supplierList) {%>
                        <!--                        <div >
                                                    <a class="<%= selectedSupplierId != null && supplier.getId() == Integer.parseInt(selectedSupplierId) ? "selected" : ""%>" href="./home?supplierId=<%= supplier.getId()%>" class="btn"><%= supplier.getCompanyName()%></a>
                                                </div>-->
